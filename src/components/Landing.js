...
const Landing = () => (
  <LandingWrapper>
    <LandingImageWrapper>
      <Image src='https://res.cloudinary.com/nicky-cloudinary/image/upload/f_auto,q_100/v1553989428/joe-good/djjoemygoodnesssticker-transparent.png' style={{ width: '90%' }} />
