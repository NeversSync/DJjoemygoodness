...
const SideProjects = () => (
  <SideProjectsWrapper id='side-projects'>
    ...
    <SideProjectsCopy>
      Everyone enjoys a good fire show. Whether it's a festival, a club, or a
      church, Atomic Flow can brighten any occasion! Specializing in Partner
      Poi, Sword, Buugeng, Torches, Staff and Hoop, Atomic Flow are master
      performers. Enjoy the primal wonder of fire, set to synergistic melodies.
      Lessons in object manipulation and fire safety available.
    </SideProjectsCopy>
    <SideProjectsLink
    ...
    <SideProjectsYoutubeWrapper>
      <iframe
        ...
        width='560'
        height='315'
        src='https://www.youtube.com/embed/6QlJfDz7pLU'
        frameBorder='0'
    ...
    <CuddleFishCopy>
      Founded in 2017, The Cuddlefish is a mutant vehicle based in Portland, OR.
      Combining a vintage Hobart airport tug, a 2-axle trailer and anatomical
      drawings of cuttlefish, The Cuddlefish was born. Home to over 4000
      individually addressable LEDs and a 2000 watt sound system this majestic
      creature measures 30 feet in length and 20 in width.
    </CuddleFishCopy>
    <SideProjectsLink
      className='custom-link'
      href='https://sites.google.com/site/atomicflowportland/'
